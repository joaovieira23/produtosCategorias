    ...
    <>
      ...
      >
          ...
          <InputLabel
            ...
            activeColor={
              props.error
                ? 'red'
                : !editable
                  ? props.inactiveBorderColor || '#cdcdcd'
                  : props.tintColor || '#cdcdcd'
            }
            inactiveColor={props.inactiveBorderColor || '#cdcdcd'}
        ...
        <View style={{
          ...
          {props.icon && !focused && !props.value && <Icon name={props.icon} style={{ marginRight: 4, alignSelf: 'center' }} size={20} color={'#cdcdcd'} />}
          <InputComponent
            type="only-numbers"
            {...inputProps}
            //@ts-ignore
            ...
            placeholderTextColor={focused ? '#cdcdcd' : '#cdcdcd'}
            scrollEnabled={false}
        ...
        {Boolean((props.deleteOption || props.loading) && editable && props.value && props.value !== '' && focused) && (
          ...
          >
            ...
            {props.loading ? <ActivityIndicator style={{ paddingHorizontal: 10 }} color={'#cdcdcd'} size="small" /> : null}
      ...
      {Boolean(props.error) && (
        ...
        >
          <Text h5 style={{ color: 'red', marginBottom: 8 }}>
            {props.error}
          </Text>
        </View>
      )}
